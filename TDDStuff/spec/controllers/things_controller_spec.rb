...
describe ThingsController do
  ...
  describe "search" do
    ...
    it "finds things via description" do
      result = subject.search_things("Floppy")
      result.should include(other_thing)
    end
 
    it "should find parts of description" do
      result = subject.search_things("lang")
      result.should include(thing)
      result.should_not include(other_thing)   
    end
